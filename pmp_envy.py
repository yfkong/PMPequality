...
d.distance_type=0
d.envy_service_objective=1 #0 for PMP, 1 for MELP or MDELP
d.envy_objective_weight_of_travelcost=1 # 0 for MELP; 1 for MDELP 
...
for x in range(d.num_districts):
    d.facilityCapacity[x]=d.total_pop
## MIP solver
d.solver_message=01
#d.pmp_mip_model(nf,100,1,t,0.0000001)

##ILS
d.ils_pmp_envy(nf,psize,t,-1)
